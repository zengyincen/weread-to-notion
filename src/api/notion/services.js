 ...
 * 将书籍数据写入Notion数据库
 */
function writeBookToNotion(apiKey, databaseId, bookData, uploadOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d;
        try {
            ...
            if (existCheck.exists && existCheck.pageId) {
                ...
                const updateResult = yield updateBookInNotion(apiKey, existCheck.pageId, bookData, uploadOptions);
                if (updateResult) {
            ...
            // 处理封面
            const processedCoverUrl = yield (0, cover_fetch_1.getBookCoverUrl)(bookData.cover, bookData.title, bookData.author || "", bookData.isbn || "", uploadOptions);
            // 构建要写入的数据
            const data = {
                parent: {
 ...
 * 更新Notion数据库中的书籍属性
 */
function updateBookInNotion(apiKey, pageId, bookData, uploadOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c, _d;
        try {
