    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield axios_1.default.post("https://api.imgur.com/3/image", formData, {
                headers: Object.assign({ "Authorization": `Client-ID ${clientId}` }, ((_a = formData.getHeaders) === null || _a === void 0 ? void 0 : _a.call(formData)) || {}),
                timeout: 20000,
            });
...
function processImportedBookCover(coverUrl, bookTitle, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Imgur 失败则尝试 GitHub
        if (!(uploadResult === null || uploadResult === void 0 ? void 0 : uploadResult.success) && options.githubToken && options.githubRepository) {
            const [owner, repo] = options.githubRepository.split("/");
            const sanitizedTitle = bookTitle.replace(/[^a-zA-Z0-9\u4e00-\u9fa5]/g, "_").substring(0, 50);
