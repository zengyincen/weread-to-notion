...
| `HEATMAP_BACKGROUND_COLOR` | `#F5F5F7` | Apple 风格外层背景 |
...
本 README 的基础部署步骤参考了原作者的项目与教程，并结合当前分支功能进行了更新：

- [sailor0913/weread-to-notion](https://github.com/sailor0913/weread-to-notion)
- [微信读书笔记一键同步 Notion，高效属于你自己的图书馆！](https://mp.weixin.qq.com/s/uOtyp-88iPIfN10szycBvg)
- [weread-to-notion 重要更新：支持按照阅读状态 / 作者同步指定书籍](https://mp.weixin.qq.com/s/EDLoitY-qFSdMl5CHvQqzA)
- [YouTube 视频教程](https://www.youtube.com/watch?v=q_k_0l2zSKA)
- [Bilibili 视频教程](https://www.bilibili.com/video/BV1n8ErzUEeB)
...
如果这个项目对你有帮助，欢迎 Star、Fork 或提交 Issue。阅读是长期主义，知识库也是。
